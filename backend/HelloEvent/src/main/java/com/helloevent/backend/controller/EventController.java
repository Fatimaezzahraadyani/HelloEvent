...
public class EventController {
    ...
    public EventController(EventService eventService, UserRepository userRepository, CategoryRepository categoryRepository, EventRepository eventRepository){
    ...
    @PostMapping
    public Event createEvent(@RequestBody EventRequest request, @RequestHeader("Authorization") String token) {
        System.out.println(request.toString());
        //return null;
        return eventService.createEvent(request, token);
    }
